...
if __name__ == '__main__':
    ...
    pretrained = Model.from_pretrained("pyannote/embedding")
    spk_probability = Inference(pretrained, step=2.5)(test_file)
    print(spk_probability)

    emb_task = SpeakerEmbedding(ami, duration=5.0, num_workers=0)
    ...
    #     torch.save(der_finetuned, "./saved_model/embedding/new_embedding_model.pt")
    # else:
